...
/*!********************************************!*\
  !*** ./Src/Signalling/socketSignalling.js ***!
  \********************************************/
/*! exports provided: websocket, startWebSocket */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"websocket\", function() { return websocket; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"startWebSocket\", function() { return startWebSocket; });\n/* harmony import */ var _transceiver__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../transceiver */ \"./Src/transceiver.js\");\n/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../logger */ \"./Src/logger.js\");\n\r\n\r\n\r\nvar websocket;\r\nfunction startWebSocket(wsUri) {\r\n\twebsocket = new WebSocket(wsUri);\r\n\twebsocket.onopen = function (evt) { onOpen(evt) };\r\n\twebsocket.onclose = function (evt) { onClose(evt) };\r\n\twebsocket.onmessage = function (evt) { onMessage(evt) };\r\n\twebsocket.onerror = function (evt) { onError(evt) };\r\n}\r\n\r\nfunction onOpen(evt) {\r\n\tObject(_logger__WEBPACK_IMPORTED_MODULE_1__[\"logger\"])(\"Signalling Connected\",_logger__WEBPACK_IMPORTED_MODULE_1__[\"log\"].info);\r\n\tstartButton.disabled = false;\r\n\tstopButton.disabled = false;\r\n}\r\n\r\nfunction onClose(evt) {\r\n\tObject(_logger__WEBPACK_IMPORTED_MODULE_1__[\"logger\"])(\"Signalling Disconnected\",_logger__WEBPACK_IMPORTED_MODULE_1__[\"log\"].info);\r\n\tstartWebSocket();\r\n}\r\n\r\nfunction onMessage(evt) {\r\n\tvar message = JSON.parse(evt.data);\r\n\tObject(_transceiver__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(message);\r\n}\r\n\r\nfunction onError(evt) {\r\n\tObject(_logger__WEBPACK_IMPORTED_MODULE_1__[\"logger\"])(\"Signalling Error: \" + evt, _logger__WEBPACK_IMPORTED_MODULE_1__[\"log\"].error);\r\n}\n\n//# sourceURL=webpack:///./Src/Signalling/socketSignalling.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"createOffer\", function() { return createOffer; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"createAnswer\", function() { return createAnswer; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"acceptAnswer\", function() { return acceptAnswer; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"addIceCandidate\", function() { return addIceCandidate; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"manageConnection\", function() { return manageConnection; });\n/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./logger */ \"./Src/logger.js\");\n/* harmony import */ var _Signalling_Signalling__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Signalling/Signalling */ \"./Src/Signalling/Signalling.js\");\n\r\n\r\n\r\nconst offerOptions = {\r\n\tofferToReceiveVideo: 1,\r\n};\r\n\r\nfunction createOffer(peer) {\r\n\tconst peerConnection = peer.peerConnection;\r\n    peerConnection.createOffer(offerOptions)\r\n\t\t.then((offer) => {\r\n\t\t\tpeerConnection.setLocalDescription(offer).then(() => {\r\n\t\t\t}).catch(error => {\r\n\t\t\t\tObject(_logger__WEBPACK_IMPORTED_MODULE_0__[\"logger\"])(\"Peer connection local description error \" + error, _logger__WEBPACK_IMPORTED_MODULE_0__[\"log\"].error);\r\n\t\t\t});\r\n\t\t\tObject(_Signalling_Signalling__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('sessionDescriptionOffer', offer, peer.id);\r\n\t\t});\r\n}\r\n\r\nfunction createAnswer(peer, offer) {\r\n\tconst peerConnection = peer.peerConnection;\r\n    peerConnection.setRemoteDescription(offer);\r\n\tpeerConnection.createAnswer()\r\n\t\t.then((answer) => {\r\n\t\t\tpeerConnection.setLocalDescription(answer).then(() => {\r\n\t\t\t}).catch(error => {\r\n\t\t\t\tObject(_logger__WEBPACK_IMPORTED_MODULE_0__[\"logger\"])(\"Peer connection local description error \" + error, _logger__WEBPACK_IMPORTED_MODULE_0__[\"log\"].error);\r\n\t\t\t});\r\n\t\t\tObject(_Signalling_Signalling__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('sessionDescriptionAnswer', answer, peer.id);\r\n\t\t});\r\n}\r\n\r\nfunction acceptAnswer(peer, answer) {\r\n\tpeer.peerConnection.setRemoteDescription(answer);\r\n}\r\n\r\nfunction addIceCandidate(peer,iceCandidate) {\r\n\tpeer.peerConnection.addIceCandidate(iceCandidate)\r\n\t\t.then(() => {\r\n\t\t\tObject(_logger__WEBPACK_IMPORTED_MODULE_0__[\"logger\"])(\"ICE candidate added\", _logger__WEBPACK_IMPORTED_MODULE_0__[\"log\"].log);\r\n\t\t}).catch(error => {\r\n\t\t\tObject(_logger__WEBPACK_IMPORTED_MODULE_0__[\"logger\"])(\"Ice candidate error \" + error, _logger__WEBPACK_IMPORTED_MODULE_0__[\"log\"].error);\r\n\t\t});\r\n}\r\n\r\nfunction manageConnection(peer) {\r\n\r\n\tconst peerConnection = peer.peerConnection;\r\n\r\n\t//Ice Candidate\r\n\t//sending iceCandidate data\r\n\tpeerConnection.onicecandidate = event => {\r\n\t\tif (event.candidate) {\r\n\t\t\tObject(_Signalling_Signalling__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('iceCandidate', event.candidate, peer.id);\r\n\t\t}\r\n\t};\r\n\r\n\tpeerConnection.addEventListener(\"negotiationneeded\", ev => {\r\n\t\tObject(_logger__WEBPACK_IMPORTED_MODULE_0__[\"logger\"])(\"Negotiation Needed\", _logger__WEBPACK_IMPORTED_MODULE_0__[\"log\"].debug);\r\n\t});\r\n\r\n\t//WebRTC connection status\r\n\tpeerConnection.addEventListener('connectionstatechange', event => {\r\n\t\tswitch(peerConnection.connectionState) {\r\n\t\t\tcase 'connected':\r\n\t\t\t\tObject(_logger__WEBPACK_IMPORTED_MODULE_0__[\"logger\"])(\"WebRTC Connected with \" + peer.id, _logger__WEBPACK_IMPORTED_MODULE_0__[\"log\"].info);\r\n\t\t\t\tbreak;\r\n\t\t\tcase 'disconnected':\r\n\t\t\t\tObject(_logger__WEBPACK_IMPORTED_MODULE_0__[\"logger\"])(\"WebRTC Disonnected with \" + peer.id, _logger__WEBPACK_IMPORTED_MODULE_0__[\"log\"].info);\r\n\t\t\t\tbreak;\r\n\t\t\tdefault:\r\n\t\t\t\tbreak;\t\t\t\r\n\t\t}\r\n\t});\r\n\r\n}\r\n\r\n\n\n//# sourceURL=webpack:///./Src/rtc.js?");
